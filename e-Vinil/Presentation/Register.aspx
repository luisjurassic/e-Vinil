<%@ Page Title="" Language="C#" MasterPageFile="~/Presentation/e-Vinil.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="e_Vinil.Presentation.Register" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    <div class="dados">
        <h1>Registro e-Vinil</h1>
        <div class="dadosAcesso">
            <h3>Dados de Acesso</h3>
            <div class="img_perfil">
                <span>Imagem de Perfil:</span>
                <asp:Image ID="imgPerfil" ImageUrl="~/css/img/account/account_img.png" runat="server" />
        ...
        <p>
            <asp:Button OnClick="btnCancelar_Click" ID="btnCancelar" Text="Cancelar" runat="server" />
